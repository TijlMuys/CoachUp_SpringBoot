...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String...args) throws Exception {
        ...
        Iterable<Account> accountlist = accountRepos.findAll();
        //If database if empty start seeding
        if(!accountlist.iterator().hasNext()) {
            ...
            location5.setStreet("Lodewijk De Raetlaan");
            location5.setNumber("223");
            location5.setZipCode("1480");
            location5.setCity("Clabecq");
            locationRepos.save(location5);

            Location location6 = new Location();
            location6.setStreet("Poolse Winglaan");
            location6.setNumber("443");
            location6.setZipCode("9630");
            location6.setCity("Sint-Maria-Latem");
            locationRepos.save(location6);

            Location location7 = new Location();
            location7.setStreet("Taille Maréchal");
            location7.setNumber("107");
            location7.setZipCode("7530");
            location7.setCity("Gaurain-Ramecroix");
            locationRepos.save(location7);
            ...
            coach.setProfileText("Vivamus tincidunt vehicula tincidunt. Integer et turpis malesuada, vulputate libero nec, cursus dolor. Etiam eleifend laoreet pharetra. Pellentesque hendrerit ipsum.");
            ...
            lesson.setLessonLocation(location5);
            ...
            lesson4.setDifficulty(2);
            lesson4.setLessonName("Mountainbike Agility");
            lesson4.setLessonDescription("In this lesson we will ride a more advanced Mountainbike Trail with improved speed.");
            lesson4.setSport(mtb);
            lesson4.setCoach(coach2);
            lesson4.setLessonLocation(location6);
            lessonRepos.save(lesson4);

            Lesson lesson5 = new Lesson();
            lesson4.setDifficulty(3);
            lesson4.setLessonName("Boxing Dodging Techniques");
            lesson4.setLessonDescription("In this lesson we will learn how to dodge attacks effectively.");
            lesson4.setSport(bowling);
            lesson4.setCoach(coach2);
            lesson4.setLessonLocation(location6);
            lessonRepos.save(lesson4);
            ...
            buddyentry.setMeetingDateTime(format.parse("2020-01-02T11:42"));
            ...
            buddyentry2.setMeetingDateTime(format.parse("2019-08-02T16:00"));
            buddyentry2.setSport(tableTennis);
            buddyentry2.setDifficulty(1);
            buddyEntryRepos.save(buddyentry2);

            BuddyEntry buddyentry3 = new BuddyEntry();
            buddyentry3.setBuddyEntryTitle("Playing Tennis");
            buddyentry3.setBuddyEntryDescription("I'm searching for someone in the area to play some tennis, I prefer to play on gravel but clay is fine too.");
            buddyentry3.setBuddyLocation(location7);
            buddyentry3.setRequestingsporter(sporter);
            buddyentry3.setMeetingDateTime(format.parse("2019-08-05T11:30"));
            buddyentry3.setSport(tennis);
            buddyentry3.setDifficulty(2);
            buddyEntryRepos.save(buddyentry3);
            ...
            if (foundAccounts3.size() != 1) {
                Account adminAccount = new Account("admin@gmail.com", "Admin", "$2a$10$f7sHcIdjKvMTGkc.8dJUFe9n.Qoaa9fvO2WzLqpZEsCalLkGGYtri", "admin", "Rue de Fromelenne", "407", "9000", "Gent", null, true, "0485 99 33687", null, null);
